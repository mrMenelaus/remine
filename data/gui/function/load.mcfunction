...
scoreboard players set #default const 0
scoreboard players set #conditional const 1
scoreboard players set #map const 2
...
execute as @a[tag=dev] at @s run function gui:core/dev
